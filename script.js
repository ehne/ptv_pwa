...
Zepto(function($){
    ...
    var url = "http://timetableapi.ptv.vic.gov.au/v3/departures/route_type/0/stop/1152?platform_numbers=2&include_cancelled=true&expand=disruption&devid=3001117&signature=CEBF7AED8AE6BEBCC8C5E0F5B28A38AB8A919EC4";
    ...
    $.getJSON(url, function(data){
       ...
       // alert("sche = " + sche);
        ...
        $.getJSON("http://timetableapi.ptv.vic.gov.au/v3/pattern/run/952519/route_type/0?expand=all&stop_id=1152&devid=3001117&signature=E2B25BE9E0C13B343BA584029755B8B2097C1F13", function(data){
